...
type Interface interface {
	...
	TagManager
	Lifecycle
	Rotate(ctx context.Context, newPassword string, params *kdf.Params) (int, error)
	VerifyAllDecryptable(ctx context.Context) error
	RetagSecret(ctx context.Context, name string, tags []string) error
