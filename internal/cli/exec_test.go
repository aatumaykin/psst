...
func (m *mockVault) Rotate(_ context.Context, _ string, _ *kdf.Params) (int, error) {
	return 0, nil
}

func (m *mockVault) VerifyAllDecryptable(_ context.Context) error {
	return nil
}

func (m *mockVault) RetagSecret(_ context.Context, _ string, _ []string) error {
	return nil
}

func (m *mockVault) Batch(fn func() error) error {
	return fn()
}
